...
public class StatisticsDto {
	...
	public StatisticsDto() {
	 ...
	 public StatisticsDto(String member_id, String member_password, String member_name, String member_addr,
	         String member_phone, String member_email, String member_birth, String member_type, String member_admin,
	         String member_gender, String member_tall, String member_keyword, String member_body, String talent_music, String talent_dance, String talent_sports,
	...
	public String toString() {
		return "StatisticsDto [member_id=" + member_id + ", member_password=" + member_password + ", member_name="
				...
				+ ", member_keyword=" + member_keyword + ", member_body=" + member_body + ", talent_music="
				+ talent_music + ", talent_dance=" + talent_dance + ", talent_sports=" + talent_sports
				+ ", talent_language=" + talent_language + ", talent_etc=" + talent_etc + "]";
	}
