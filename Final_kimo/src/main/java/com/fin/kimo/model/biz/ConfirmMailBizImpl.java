...
@Service
public class ConfirmMailBizImpl implements ConfirmMailBiz{
...
//		System.out.println("인증 번호 : " + ePw);
		...
		message.setSubject("KIMO 회원가입 이메일 인증");// 제목

		String msgg = "";
		msgg += "<div style='margin:100px;'>";
		msgg += "<h1> 안녕하세요</h1>";
		msgg += "<h1> 통합 오디션 정보 포탈 KIMO 입니다</h1>";
		msgg += "<br>";
		...
		message.setFrom(new InternetAddress("paekma09@naver.com", "KIMO_Admin"));// 보내는 사람
