...
public class Member {
	...
	public Member(String memberId, String memberPassword, String member_name, String member_addr,
	...
	public String toString() {
		return "Member [memberId=" + memberId + ", memberPassword=" + memberPassword + ", member_name=" + member_name
				+ ", member_addr=" + member_addr + ", member_phone=" + member_phone + ", member_email=" + member_email
				+ ", member_birth=" + member_birth + ", member_type=" + member_type + ", member_admin=" + member_admin
				+ ", member_gender=" + member_gender + ", member_tall=" + member_tall + ", member_keyword="
				+ member_keyword + ", member_body=" + member_body + "]";
	}
