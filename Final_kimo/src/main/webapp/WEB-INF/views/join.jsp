...
<div id="register_agree">
    ...
    <form  name="fregister" id="fregister" action="/member/signupform" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off">
...
2) 시행일자 : 2018년 05월 01일 </textarea>
    ...
    <div class="btn_confirm">
		<a href="/member/login" class="btn_cancel">CANCEL</a>
        <input type="submit" class="btn_submit" value="JOIN" id="btn_submit" onclick="location.href='/member/join'">
    </div>
