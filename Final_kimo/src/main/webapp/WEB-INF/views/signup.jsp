                ...
                <div class="col-4" style="background-color: rgb(36, 36, 36); border-radius: 15px;">
                        ...
                        <label for="id" class="form-label pt-3">아이디</label>
                       	<c:choose>
                       		<c:when test="${member_id == null }">
                       			<input type="text" class="form-control" name="member_id" id="id" pattern="^[a-z0-9]{6,15}$" oninput="checkId(event)" minlength="6" maxlength="15" value="" />
                       		</c:when>
                       		<c:otherwise>
                       			<input type="text" class="form-control" name="member_id" id="id" pattern="^[a-z0-9]{6,15}$" oninput="checkId(event)" minlength="6" maxlength="15" value="<%=member_id %>" />
                       		</c:otherwise>
                       	</c:choose>
                        <div id="id_check"></div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <c:choose>
                        	<c:when test="${member_name == null }">
		                        ...
		                        pattern="^[가-힣]+$"
		                        oninput="checkName(event)" maxlength="20" value="" />
                        	</c:when>
                        	<c:otherwise>
                        		<input type="text" class="form-control" name="member_name" id="name" 
		                        pattern="^[가-힣]+$"
                    ...
                    <div class="row g-0 pb-3">
                        <div class="col-9">
                            ...
                            <c:choose>
                            	<c:when test="${member_email == null }">
                            		<input type="email" class="form-control" name="member_email" id="email" oninput="emailCheck(event)" value="" />
                            	</c:when>
                            	<c:otherwise>
