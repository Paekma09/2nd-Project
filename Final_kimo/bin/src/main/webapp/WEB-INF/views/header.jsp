        ...
        <div class="container-fluid collapse navbar-collapse" id="navbarNav">
            <div class="mx-auto justify-content-center">
              ...
              <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <ul class="navbar-nav">
                    <a class="navbar-brand" href="#"><img src="/resources/img/logo_header.png" width="50px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">오디션&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">인재검색&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">유료서비스안내</a>
                  </li>
                </ul>
            </div>
                <div class="dropdown ">
                    <button class="btn dropdown-toggle" style="background-color: #020204;"  type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="/resources/img/bell.png" width="30px">
                    </button>
                    <ul class="dropdown-menu dropdown-menu-lg-end">
                      <li><button class="dropdown-item" type="button">알림왔음</button></li>
                    </ul>
                </div>
                <div class="dropdown ">
